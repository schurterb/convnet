...
results_folder = 'results/RMSprop_5/'
...
num_layers = 10
num_filters = 10
filter_size = 7 #This only one side of each filter, which are assumed to be cubic
activation = 'relu'
#cost_func = 'MSE'
...
network_trainer = Trainer(network, training_data.get_data(), training_data.get_labels(),
                          ...
                          learning_rate = learning_rate, beta1 = decay_rate,
                          damping = damping,
